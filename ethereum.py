...
def bald(str):
    link = f"https://ethereum.atomicwallet.io/address/{str}"
    session = HTMLSession()
    response = session.get(link)
    meta_desc = response.html.xpath('/html/body/main/div/div[2]/div[1]/table/tbody/tr[2]/td[2]')
    return meta_desc[0].text
...
for i in range(0, len(mylist)):
    ...
    if int(txid) > 0:
        ...
        (w) + '[/][magenta2] ETH [/][red1] ADDR[/]= [with on blue]' + str
                      (addr) + '[/] [khaki1] --[wheat1]-[cornsilk1]-[cornsilk1]-[wheat1]-[wheat1]-[khaki1]-[light_goldenrod1] T[yellow1]O[yellow1]T[yellow2]A[yellow3]L[gold1] TX : [orange3]' + str
                      (txid) + '[/][yellow]  Passphrase:[green]' + str(passphrase) + '[/]')
    else:
        console.print('[gold1]Total:[white]' + str(count) + '[/][gold1]-- Win:[white]' + str
        (w) + '[/][b magenta2] ETH [red1] ADDR[/]= ' + str
                      (addr) + ' [khaki1] --[wheat1]-[cornsilk1]-[cornsilk1]-[wheat1]-[wheat1]-[khaki1]-[light_goldenrod1] T[yellow1]O[yellow1]T[yellow2]A[yellow3]L[gold1] TX : [orange3]' + str
                      (txid) + '[/][yellow]  Passphrase:[green]' + str(passphrase) + '[/]')
