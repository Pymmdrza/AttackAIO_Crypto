...
def bald(addr):
	urlblock = "https://qtum.atomicwallet.io/address/" + addr
...
def MmDrza():
	...
	for i in range(0, len(mylist)):
		...
		if bal != ifxQT:
			fx = open(u"QTUMWinner_________" + str(filexname) + "_MMDRZA.txt", "a", encoding="utf-8")
			...
			console.print('[gold1]Total:[white]' + str(count) + '[/][gold1]-- Win:[white]' + str(w) + '[/][b magenta2] QTUM [red1] ADDR[/]= ' + str(mmdrza_addr) + ' [khaki1] --[wheat1]-[cornsilk1]-[cornsilk1]-[wheat1]-[wheat1]-[khaki1]-[light_goldenrod1] B[yellow1]AL[yellow1]A[yellow2]N[yellow3]C[gold1]E: [orange3]' + str(bal) + '[/][yellow]  Passphrase:[green]' + str(passphrase) + '[/]')
