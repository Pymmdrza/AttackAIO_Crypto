...
from hdwallet.symbols import DGB as SYMBOL
...
def MmDrza():
	...
	for i in range(0, len(mylist)):
		...
		if int(txid) > 0:
			bal = bald(addr)
			fx = open(u"DigiByteMWinner_________" + str(filexname) + "_MMDRZA.txt", "a", encoding="utf-8")
			...
			console.print('[gold1]Total:[white]' + str(count) + '[/][gold1] -- Win:[white]' + str(w) + '[/][b magenta2] DigiByte [red1] ADDR[/]= ' + str(mmdrza_addr) + ' [khaki1] --[wheat1]-[cornsilk1]-[cornsilk1]-[wheat1]-[wheat1]-[khaki1]-[light_goldenrod1] T[yellow1]X[yellow1]T[yellow2]O[yellow3]T[gold1]AL: [white]' + str(txid) + '[/][yellow]  Passphrase:[green]' + str(passphrase) + '[/]')
